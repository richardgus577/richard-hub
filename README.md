...
local Window = OrionLib:MakeWindow({Name = "Richard Hub", HidePremium = false, IntroText = "", SaveConfig = true, ConfigFolder = "Richard Hub"})
...
W:AddLabel("[+] Richard Hub is HERE!")
...
pcall(function()
    while wait() do
        if _G.AutoEliteHunter then
            if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                OrionLib:MakeNotification({
                    Name = "Richard Hub(Noitification)",
